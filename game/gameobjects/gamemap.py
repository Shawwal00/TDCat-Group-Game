...
class GameMap:
    ...
    def __init__(self, renderer: pyasge.Renderer, tmx_file: str) -> None:
        ...
        # Make spawn and home points for the rodents to path to
        self.spawn_points = []
        for obj in tmxdata.layernames["spawn_points"]:
            self.spawn_points.append(((obj.x + obj.width/2)*2, (obj.y + obj.height/2)*2))

        self.home_points = []
        for obj in tmxdata.layernames["home_points"]:
            self.home_points.append(((obj.x + obj.width/2)*2, (obj.y + obj.height/2)*2))
    ...
    def render(self, renderer: pyasge.Renderer, game_time: pyasge.GameTime) -> None:
        ...
        renderer.render(self.rt.buffers[0], [0, 0, px_wide, px_high], 0, 0, px_wide, px_high, -1)
